...
# Drill into the downloaded zip until you see a bunch of files and stick them into a new "Interface/AddOns/AdiBags" folder
...
Troubleshooting:
* Ensure you have the AdiBags.toc file at "Interface/AddOns/AdiBags/AdiBags.toc"
* Ensure you have the AdiBags_Config.toc file at "Interface/AddOns/AdiBags_Config/AdiBags_Config.toc"
* Ensure you installed the AddOn into your classic installation, not retail.
